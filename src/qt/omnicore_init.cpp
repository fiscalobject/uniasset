...
static bool getDisclaimerDialogResult()
{
    ...
    "By default this software will use your existing UFO wallet, including spending "
    "ufos contained therein (for example for transaction fees or trading).\n\n"
    ...
    "own risk. Neither Uniform Fiscal Object nor the Uniasset developers assumes "
    ...
    "EXPERIMENTAL. Your wallet data, ufos and Omni Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of ufos or Omni Layer "
