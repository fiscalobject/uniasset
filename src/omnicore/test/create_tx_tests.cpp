...
BOOST_AUTO_TEST_CASE(txbuilder_add_change)
{
    ...
    CTxDestination addrA = DecodeDestination("ByBkGve2RPDykiFrYTYgAcqd7UFYBqpFTg");
    CTxDestination addrB = DecodeDestination("BtpFaVNvqyQAxDsFYTsTi4xiT225Mtm18M");
...
BOOST_AUTO_TEST_CASE(txbuilder_add_change_position)
{
    ...
    CTxDestination addr = DecodeDestination("C5RYKAXvdyyM3vKq7LtDHeeTgqbtodSnvg");
...
BOOST_AUTO_TEST_CASE(omnitxbuilder_op_return)
{
    ...
    tx = OmniTxBuilder(tx)
        .addOpReturn(payload)
        .addReference("BtnrzXw535ctGxhzK2gttouCi3hSR8e6dq", 2730LL)
        .addChange("CAwCykAJLzyPgnzNKpPKnLt8fPoiZCB5XJ", viewTemp, 10000LL, 1)
        .build();
