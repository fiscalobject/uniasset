...
BOOST_AUTO_TEST_CASE(payload_freeze_tokens)
{
    ...
    std::vector<unsigned char> vch = CreatePayload_FreezeTokens(
        ...
        std::string("CEXodUs3feFVbq2zfvBimFdpS4evGZq15c"));         // reference address

    BOOST_CHECK_EQUAL(HexStr(vch),
        "000000b90000000400000000000003e81beacd49ba4a172ad562976e7390ea1d1b7d48bd6d");
}
...
BOOST_AUTO_TEST_CASE(payload_unfreeze_tokens)
{
    ...
    BOOST_CHECK_EQUAL(HexStr(vch),
        "000000ba0000000400000000000003e81beacd49ba4a172ad562976e7390ea1d1b7d48bd6d");
}
