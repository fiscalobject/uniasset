...
BOOST_AUTO_TEST_CASE(valid_common_class_b)
{
    ...
    txInputs.push_back(createTxOut(1000000, "C9qpRzAyp1hHuFwDQnDSUdDCRRzdqHYjtU"));
    txInputs.push_back(createTxOut(1000000, "CEuLFe2ZrbyfQjVjzsjf8UYo2ZqKdfx4Xx"));
    txInputs.push_back(createTxOut(2000001, "BxqG3c3DAdHFjuaycZee3uP8Dwg5vKDq4w"));
    ...
    BOOST_CHECK_EQUAL(metaTx.getSender(), "BxqG3c3DAdHFjuaycZee3uP8Dwg5vKDq4w");
...
BOOST_AUTO_TEST_CASE(valid_arbitrary_output_number_class_b)
{
    ...
    std::vector<CTxOut> txInputs;
    txInputs.push_back(createTxOut(5550000, "Uj17r8smshJWwvywhzshCkSDpubuD6KTdc"));
    ...
    CMPTransaction metaTx;
    BOOST_CHECK(ParseTransaction(dummyTx, nBlock, 1, metaTx) == 0);
    BOOST_CHECK_EQUAL(metaTx.getSender(), "Uj17r8smshJWwvywhzshCkSDpubuD6KTdc");
