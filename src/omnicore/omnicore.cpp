...
static std::string exodus_address = "CEXodUs3feFVbq2zfvBimFdpS4evGZq15c";

//! Mainnet Exodus address
static const std::string exodus_mainnet = "CEXodUs3feFVbq2zfvBimFdpS4evGZq15c";
...
static bool HasMarkerUnsafe(const CTransactionRef& tx)
{
    ...
    const std::string strClassAB("76a914eacd49ba4a172ad562976e7390ea1d1b7d48bd6d88ac");
...
int mastercore::GetEncodingClass(const CTransaction& tx, int nBlock)
{
    ...
    std::string strClassAB = "76a914eacd49ba4a172ad562976e7390ea1d1b7d48bd6d88ac";
