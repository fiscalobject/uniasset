...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.config = config
        self.options.bitcoind = os.getenv("OMNIUFOD", default=config["environment"]["BUILDDIR"] + '/src/uniassetd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("OMNIUFOCLI", default=config["environment"]["BUILDDIR"] + '/src/uniasset-cli' + config["environment"]["EXEEXT"])
