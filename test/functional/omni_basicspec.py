...
class OmniBasicSpec(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        payload = "00000000000000030000000000000001" # Simple Send: transfer  0.00000001 TST
        ...
        payloads = {"00010014000000030000000005f5e1000000000059682f000a00000000000003e801",# Tx 20: Offer 1,0 TST for 0.15 BTC on the traditional exchange
